...
function bind() {
    ...
    document.querySelectorAll('[data-ui="rules"]').forEach(el => el.addEventListener('click', () => { rulesOpen = true; render(); }));
    document.querySelectorAll('[data-ui="close-rules"]').forEach(el => el.addEventListener('click', () => { rulesOpen = false; render(); }));
}
